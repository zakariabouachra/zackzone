...
<?php   echo $row_admin['admin_name']; ?> <b class="caret"></b>    
</a>  <!--dropdown-toggl start-->
<ul class="dropdown-menu"><!--dropdown menu starts-->
<li>

<a href="index.php?user_profile=<?php echo $row_admin ['admin_id'];  ?>">
...
<li class="divider"></li> 
<li>
<a href="\CoursCM_2\ProjetFinal\Controllers\adminController.php?action=logout">
<i class="fa fa-fw fa-power-off"></i>Log Out    
 ...
 <i class="fa fa-fw fa-caret-down"></i>
  ...
  <ul id="users" class="collapse">
    ...
    <li>
      <a href="index.php?user_profile=<?php echo $row_admin ['admin_id'];  ?>">Edit Profile</a> 
    </li>
